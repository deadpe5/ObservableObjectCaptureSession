...
/// The state machine used by ``OnboardingView`` to show the tutorial and texts depending on its `currentState`.
...
class OnboardingStateMachine {
    ...
    private let initialStates: [OnboardingState] = [
        .tooFewImages,
    ...
    private func transitions(for state: OnboardingState) -> [Transition] {
