...
class TimedMessageList {
    ...
    struct Message: Identifiable {
        ...
        /// Returns a `Bool` that indicates whether the message's expiration date is in the past.
    ...
    /// Sets timer to fire when the message with the nearest expiration date (in the future) expires.
